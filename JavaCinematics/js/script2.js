...
//isabel
const memoryExplanations = [
  "Declare variable x and assign it the value 13.",
  "x is now stored in memory.",
  "Declare variable y and assign it the value 5.",
  "y is now stored in memory.",
  "Declare variable add to store the sum of x and y.",
  "Bring x and y down to perform addition.",
  "Calculate x + y and store the result in add.",
  "Store the result of addition in memory.",
  "Print the value of add.",
  "Declare variable sub to store the difference of x and y.",
  "Bring x and y down to perform subtraction.",
  "Calculate x - y and store the result in sub.",
  "Store the result of subtraction in memory.",
  "Print the value of sub.",
  "Declare variable mul to store the product of x and y.",
  "Bring x and y down to perform multiplication.",
  "Calculate x * y and store the result in mul.",
  "Store the result of multiplication in memory.",
  "Print the value of mul.",
  "Declare variable div to store the quotient of x and y.",
  "Bring x and y down to perform division.",
  "Calculate x / y and store the result in div.",
  "Store the result of division in memory.",
  "Print the value of div.",

  // Add more messages as needed for each step up to 38
];

const steps = memoryExplanations.length;
let current = -1;
...
function updateHighlight() {
  // Update memory explanation section -isabel
  const explanationDiv = document.getElementById("memory-explanation");
  if (explanationDiv) {
    if (current >= 0 && current < memoryExplanations.length) {
      explanationDiv.textContent = memoryExplanations[current];
    } else {

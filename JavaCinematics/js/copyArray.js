...
const lineLoopIInit = Array.from(lines).findIndex((line) =>
  line.textContent.includes("for (int i = 0,"),
);
const lineLoopJInit = Array.from(lines).findIndex((line) =>
  line.textContent.includes("j = result.length - 1;"),
);
const lineLoopCond = Array.from(lines).findIndex((line) =>
  line.textContent.includes("i < list.length;"),
);
const lineLoopUpdate = Array.from(lines).findIndex((line) =>
  line.textContent.includes("i++, j--) {"),
);
...
const steps = [
  ...
  {
    message: "Initialize i in for loop: int i = 0.",
    highlight: [lineLoopIInit],
    list: [1, 2, 3, 4, 5, 6],
    result: [0, 0, 0, 0, 0, 0],
    list2: [0, 0, 0, 0, 0, 0],
    iValue: "0",
  ...
  {
    message: "Initialize j in for loop: j = result.length - 1 -> 5.",
    highlight: [lineLoopJInit],
    list: [1, 2, 3, 4, 5, 6],
    result: [0, 0, 0, 0, 0, 0],
    list2: [0, 0, 0, 0, 0, 0],
    iValue: "0",
  ...
  {
    message: "Check loop condition: i < list.length.",
    highlight: [lineLoopCond],
    list: [1, 2, 3, 4, 5, 6],
    result: [0, 0, 0, 0, 0, 0],
    list2: [0, 0, 0, 0, 0, 0],
    iValue: "0",
    jValue: "5",
    calc: { left: "0", op: "<", right: "6", result: "true" },
    move: null,
  },
  {
  ...
  {
    message: "Update loop variables: i++, j--.",
    highlight: [lineLoopUpdate],
    list: [1, 2, 3, 4, 5, 6],
    result: [0, 0, 0, 0, 0, 1],
    list2: [0, 0, 0, 0, 0, 0],
    iValue: "1",
  ...
  },
  {
    ...
    iValue: "1",
    jValue: "4",
    calc: { left: "1", op: "<", right: "6", result: "true" },
    move: null,
  },
  {
    message: "result[4] = list[1] -> 2",
    highlight: [lineAssign],
    list: [1, 2, 3, 4, 5, 6],
    result: [0, 0, 0, 0, 2, 1],
    list2: [0, 0, 0, 0, 0, 0],
  ...
  },
  {
    ...
    iValue: "2",
    jValue: "3",
    calc: { left: "2", op: "<", right: "6", result: "true" },
    move: null,
  },
  {
    message: "result[3] = list[2] -> 3",
    highlight: [lineAssign],
    list: [1, 2, 3, 4, 5, 6],
    result: [0, 0, 0, 3, 2, 1],
    list2: [0, 0, 0, 0, 0, 0],
  ...
  },
  {
    ...
    iValue: "3",
    jValue: "2",
    calc: { left: "3", op: "<", right: "6", result: "true" },
    move: null,
  },
  {
    message: "result[2] = list[3] -> 4",
    highlight: [lineAssign],
    list: [1, 2, 3, 4, 5, 6],
    result: [0, 0, 4, 3, 2, 1],
    list2: [0, 0, 0, 0, 0, 0],
  ...
  },
  {
    ...
    iValue: "4",
    jValue: "1",
    calc: { left: "4", op: "<", right: "6", result: "true" },
    move: null,
  },
  {
    message: "result[1] = list[4] -> 5",
    highlight: [lineAssign],
    list: [1, 2, 3, 4, 5, 6],
    result: [0, 5, 4, 3, 2, 1],
    list2: [0, 0, 0, 0, 0, 0],
  ...
  },
  {
    ...
    iValue: "5",
    jValue: "0",
    calc: { left: "5", op: "<", right: "6", result: "true" },
    move: null,
  },
  {
    message: "result[0] = list[5] -> 6",
    highlight: [lineAssign],
    list: [1, 2, 3, 4, 5, 6],
    result: [6, 5, 4, 3, 2, 1],
    list2: [0, 0, 0, 0, 0, 0],
  ...
  },
  {
    ...
    iValue: "6",
    jValue: "-1",
    calc: { left: "6", op: "<", right: "6", result: "false" },
    move: null,
  },
  {
...
function renderStep() {
  ...
  if (current < 0) {
    ...
    memI.innerText = "";
    memJ.innerText = "";
    if (itemI) itemI.style.display = "none";
    if (itemJ) itemJ.style.display = "none";
  ...
  if (itemI) itemI.style.display = showI ? "flex" : "none";
  if (itemJ) itemJ.style.display = showJ ? "flex" : "none";

  if (itemListRef) itemListRef.style.display = showList ? "flex" : "none";
  if (itemReverseRef)
    itemReverseRef.style.display = showResult ? "flex" : "none";
  ...
  if (step.move && isForward) {
    ...
    animateValue(
      listCells[step.move.fromListIndex],
      targetCell,
      step.move.value,
      700,
    );

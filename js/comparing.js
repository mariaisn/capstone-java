...
function setReferenceValue(targetElement, charsElement, storedValue) {
  ...
  if (current === 4) {
    c1Arr = targetElement._storedArray;
  } else if (current === 8) {
    c2Arr = targetElement._storedArray;
  }
...
function updateUI() {
  ...
  const printOut = [
    ...
    {
      step: 14,
      output: "The cities in alphabetical order are: " + city1 + " " + city2,
      from: "a1",
    },
    {
      step: 16,
      output: "The cities in alphabetical order are: " + city2 + " " + city1,
      from: "a2",
    },
  ];

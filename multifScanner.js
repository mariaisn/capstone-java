...
function updateMemoryExplanation() {
  ...
  if (current === 0) message = "Import Scanner";
    ...
    message = "Creating object name input from class Scanner to get user input.";
  ...
  else if (current === 6) message = hasY() ? "y stored" : "Input y";
  else if (current === 7) message = "Check x > y";
  else if (current === 8) message = "Calculate result";
  else if (current === 9) message = "Print x";
  else if (current === 10) message = "Check x < y";
  else if (current === 11) message = "Print y";
  else if (current === 12) message = "Check x == y";
  else if (current === 13) message = "Print equal";
  else message = "Done!";
